...
export const categories = [
  ...
  { id: 'Main Courses', nameKey: 'menu_category_main_courses' },
...
export const menuItems: MenuItem[] = [
  ...
  // Main Courses
  { id: 6, name: "Himalayan Lamb Tenderloin", description: "Slow-cooked lamb with aromatic spices", price: 68, category: 'Main Courses', image: "https://images.unsplash.com/photo-1546833999-b9f581a1996d", rating: 4.9 },
  { id: 7, name: "Peak Wagyu Experience", description: "A5 Japanese Wagyu beef with bone marrow", price: 120, category: 'Main Courses', image: "https://images.unsplash.com/photo-1558030006-450675393462", rating: 4.8 },
  { id: 8, name: "Mount Everest Seafood Platter", description: "Fresh lobster, sea bass, and prawns", price: 85, category: 'Main Courses', image: "https://images.unsplash.com/photo-1559847844-d721426d6edc", rating: 5.0 },
  { id: 9, name: "Duck Confit", description: "Traditional French duck leg with cherry sauce", price: 45, category: 'Main Courses', image: "https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b", rating: 4.7 },
  { id: 10, name: "Venison Medallions", description: "Wild venison with juniper and blackberry", price: 52, category: 'Main Courses', image: "https://images.unsplash.com/photo-1544025162-d76694265947", rating: 4.6 },
